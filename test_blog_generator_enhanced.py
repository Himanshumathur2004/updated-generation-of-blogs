...
# Set up detailed logging to capture HTTP details
logging.basicConfig(level=logging.DEBUG, format='%(name)s - %(levelname)s - %(message)s')

# Add the current directory to the path
sys.path.insert(0, os.getcwd())

print('=== Blog Generator Test Script with Enhanced Debugging ===')
...
try:
    ...
    print()
    print('    ? Blog generation call completed')
    print()
